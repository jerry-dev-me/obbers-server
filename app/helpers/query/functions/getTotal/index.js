...
//     { totalPosts: 1 }
//   );
//   if (foundUser && foundUser.totalPosts)
//     return foundUser.totalPosts;
//   else return 0;
// };
//
...
//     { totalLikedPosts: 1 }
//   );
//   if (foundUser && foundUser.totalLikedPosts)
//     return foundUser.totalLikedPosts;
//   else return 0;
// };
//
...
//     { totalTaggedPosts: 1 }
//   );
//   if (foundUser && foundUser.totalTaggedPosts)
//     return foundUser.totalTaggedPosts;
//   else return 0;
// };
//
...
//     { totalCollections: 1 }
//   );
//   if (foundUser && foundUser.totalCollections)
//     return foundUser.totalCollections;
//   else return 0;
// };
//
...
//     { totalFollowing: 1 }
//   );
//   if (foundUser && foundUser.totalFollowing)
//     return foundUser.totalFollowing;
//   else return 0;
// };
//
...
//     { totalFollowers: 1 }
//   );
//   if (foundUser && foundUser.totalFollowers)
//     return foundUser.totalFollowers;
//   else return 0;
// };
//
...
//     return foundUser.totalRequests;
//   else return 0;
// };
//
...
//     // { totalComments: 1 }
//   );
//   if (foundPost && foundPost.totalComments)
//     return foundPost.totalComments;
//   else return 0;
// };
//
...
//     { totalLikes: 1 }
//   );
//   if (foundPost && foundPost.totalLikes)
//     return foundPost.totalLikes;
//   else return 0;
// };
//
...
//     { totalLikes: 1 }
//   );
//   if (foundComment && foundComment.totalLikes)
//     return foundComment.totalLikes;
//   else return 0;
// };
//
...
//     { totalLikes: 1 }
//   );
//   if (foundResponse && foundResponse.totalLikes)
//     return foundResponse.totalLikes;
//   else return 0;
// };

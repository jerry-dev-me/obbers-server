...
//
// const queryFunc = async (testUserId, postId, tagId) =>
//   await q.features.tag.delete.byId(writerId, postId, tagId);
//
// describe("\n query function: tag.delete.byId()", async function() {
//   this.timeout(0);
//
//   let data;
//   let testUserId;
...
//       const funcResults = await queryFunc(testUserId, postId, tagId);
//       logger.log(lG, lS, null, { funcResults });
//       assert(!(funcResults instanceof Error));
//     });

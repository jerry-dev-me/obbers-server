...
//
// const queryFunc = async (writerId, postId, tagId, newPosition) =>
//   await q.features.tag.update.position(writerId, postId, tagId, newPosition);
//
// describe("\n query function: tag.update.position()", async function() {
//   this.timeout(0);
//
//   let data;
//   let testUserId;

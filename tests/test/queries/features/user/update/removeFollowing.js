...
//
// const queryFunc = async (writerId, userIdToUnfollow) =>
//   await q.user.update.removeFollowing(writerId, userIdToUnfollow);
//
// describe("\n query function: user.update.removeFollowing()", async function() {
//   this.timeout(0);
//
//   let data;
//   let testUserId;

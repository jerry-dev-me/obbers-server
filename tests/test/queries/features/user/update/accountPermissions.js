...
//     return await q.features.user.update.accountPermissions.admin(writerId);
//   },
//   readWrite: async writerId => {
//     return await q.features.user.update.accountPermissions.readWrite(writerId);
//   },
//   readOnly: async writerId => {
//     return await q.features.user.update.accountPermissions.readOnly(writerId);
//   }
// };
//
// // const queryFunc = async writerId =>
// //   await q.features.user.update.accountPermissions(writerId);
//
// describe("\n query function: user.update.accountPermissions()", async function() {
//   this.timeout(0);
//
//   let data;
//   let testUserId;

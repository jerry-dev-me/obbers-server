...
//
// const queryFunc = async (writerId, currentPassword, newPassword) =>
//   await q.features.user.update.password(writerId, currentPassword, newPassword);
//
// describe("\n query function: user.update.password()", async function() {
//   this.timeout(0);
//
//   let data;
//   let testUserId;

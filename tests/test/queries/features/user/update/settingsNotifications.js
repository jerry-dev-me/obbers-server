...
// const queryFunc = {
//   true: async writerId => {
//     return await q.user.update.settingsNotifications.true(writerId);
//   },
//   false: async writerId => {
//     return await q.user.update.settingsNotifications.false(writerId);
//   }
// };
//
// // const queryFunc = async () => await q.user.update.settingsNotifications(writerId);
//
// describe("\n query function: user.update.settingsNotifications()", async function() {
//   this.timeout(0);
//
//   let data;
//   let testUserId;

...
//
// const queryFunc = async (writerId, idToBlock) =>
//   await q.features.user.update.addBlocked(writerId, idToBlock);
//
// describe("\n query function: user.update.addBlocked()", async function() {
//   this.timeout(0);
//
//   let data;
//   let testUserId;

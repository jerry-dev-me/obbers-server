...
// const queryFunc = {
//   en: async writerId => {
//     return await q.user.update.settingsLanguage.en(writerId);
//   },
//   es: async writerId => {
//     return await q.user.update.settingsLanguage.es(writerId);
//   },
//   fr: async writerId => {
//     return await q.user.update.settingsLanguage.fr(writerId);
//   }
// };
//
// // const queryFunc = async () => await q.user.update.settingsLanguage(writerId);
//
// describe("\n query function: user.update.settingsLanguage()", async function() {
//   this.timeout(0);
//
//   let data;
//   let testUserId;

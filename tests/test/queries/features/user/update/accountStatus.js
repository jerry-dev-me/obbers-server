...
//     return await q.features.user.update.accountPermissions.active(writerId);
//   },
//   inactive: async writerId => {
//     return await q.features.user.update.accountPermissions.inactive(writerId);
//   },
//   suspended: async writerId => {
//     return await q.features.user.update.accountPermissions.suspended(writerId);
//   },
//   banned: async writerId => {
//     return await q.features.user.update.accountPermissions.banned(writerId);
//   }
// };
//
// // const queryFunc = async writerId =>
// //   await q.features.user.update.accountStatus(writerId);
//
// describe("\n query function: user.update.accountStatus()", async function() {
//   this.timeout(0);
//
//   let data;
//   let testUserId;

...
//
// const queryFunc = async fields => await q.features.user.create.new(fields);
//
// describe("\n query function: user.create.new()", async function() {
//   this.timeout(0);
//
//   let data;
//   let testUserId;
//
//   before(async () => {
//     data = await testData.user.create();
...
//       const fields = data;
//       const funcResults = await queryFunc(fields);
//       logger.log(lG, lS, null, { funcResults });
//       assert(!(funcResults instanceof Error));
//       // assert(funcResults.local.email === fields.local.email);
//       // assert(funcResults.local.password === fields.local.password);
//       // assert(funcResults.info.avatar === fields.info.avatar);
//       // assert(funcResults.info.username === fields.info.username);

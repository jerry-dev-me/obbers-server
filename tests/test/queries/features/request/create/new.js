...
const queryFunc = async (sentFromUserId, sentToUserId) =>
  await q.features.request.create.new(sentFromUserId, sentToUserId);

describe("\n query function: request.create.new()", async function() {
  this.timeout(0);

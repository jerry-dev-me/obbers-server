...
const queryFunc = async sentToUserId =>
  await q.features.request.read.allSentToUserId(sentToUserId);

describe("\n query function: request.read.allSentToUserId()", async function() {
  this.timeout(0);

...
const lS = "REPORT-R-ALL"; // logSubgroup
...
const queryFunc = async readerId => await q.features.report.read.all(readerId);

describe("\n query function: report.read.all()", async function() {
  this.timeout(0);

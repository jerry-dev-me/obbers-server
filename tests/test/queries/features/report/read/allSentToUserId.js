...
const queryFunc = async (readerId, sentToUserId) =>
  await q.features.report.read.allSentToUserId(readerId, sentToUserId);

describe("\n query function: report.read.allSentToUserId()", async function() {
  this.timeout(0);

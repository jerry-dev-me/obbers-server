...
const basicProfile = require("../../../../app/queries/verifyUser/profiles/basicProfile");
const fullProfile = require("../../../../app/queries/verifyUser/profiles/fullProfile");
const personalProfile = require("../../../../app/queries/verifyUser/profiles/personalProfile");
...
const _q = {
  ...
  getProfileFields: async (readerId, userIdToRead) => {
    return await q.verifyUser.getProfileFields(readerId, userIdToRead);
  }
}

describe("\nqueries verify user: getProfileFields()", async function() {
  this.timeout(0);
  ...
  describe("\n testUser1 account status", async function() {
    let case1 = `
    testUser1 reads tesUser2 profile,
    ...
    it(case1, async () => {
      ...
      const profileFields =
        await _q.getProfileFields(testUser1._id, testUser2._id);
      console.log("profileFields:");
      console.log(profileFields);
      assert(JSON.stringify(profileFields) === JSON.stringify(fullProfile));
    });
  ...
  describe("\n social connections", async function() {
    ...
    it(case2, async () => {
      ...
      console.log("profileFields:");
      console.log(profileFields);
      assert(JSON.stringify(profileFields) === JSON.stringify(basicProfile));
    });
